...
int Statespace::operator- (Statespace s) const   // For Hamming Distance
{
    int count=0;
    for (int i=0; i<3; i++)
    {
...
inline int Move(char pos)
{
     ...
     //Applying heuristic to set value of the state
     heuristic=Goal-st;
     st.Eval=heuristic; 
...
int main()
{
    ...
    Initial.Eval=Initial-Goal;  //Applying Heuristic
